...
- **[Завантажити українізатор — ZIP](https://github.com/fenrir-live/hogwarts-legacy-ukrainian/releases/download/v0.9.2-beta/Hogwarts-Legacy-UA-0.9.2-beta.zip)**
- **[Відкрити сторінку випуску](https://github.com/fenrir-live/hogwarts-legacy-ukrainian/releases/tag/v0.9.2-beta)**
...
**0.9.2-beta — випуск для тестування.** Пак містить переклад інтерфейсу, завдань, описів, записок і субтитрів. Структурна перевірка не замінює проходження гри: можливі неточності, проблеми узгодження роду, контексту та відображення тексту. Будемо вдячні за повідомлення про них.
...
4. Натисніть **Hogwarts-Legacy-UA-0.9.2-beta.zip**. У наступних випусках номер версії в назві змінюватиметься.
